...
for chrom sizes I'd like /fhgfs/share/data/ucsc/chromInfo.hg19.txt
usage:
...
#open(BIGWIG, "| wigToBigWig -clip stdin $cs $outfolder/exact.bw");
open(BIGWIG, " > $outfolder/exact.wig");
...
#	else {	$begin = 1;		}
	...
	#open(OUT, ">>$outfolder/chr.wig");
	print BIGWIG "fixedStep chrom=chr$currentChromosome start=$begin step=1\n";
