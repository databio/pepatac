...
t1<-theme(
  ...
  axis.text.y = element_text(face = "plain", color = "black", size = 20, hjust = 0.5),
...
if (outputType == "png") {
  ...
  pre + t1  + scale_x_continuous(expand=c(0,0)) + scale_y_continuous(expand=c(0,0)) +
    coord_cartesian(xlim=c(-2300,2300), ylim=c(0,32)) + #ylim(0,30) + xlim(-2100,2100) + 
    annotate("rect", xmin=1200, xmax=2300, ymin=27, ymax=32, fill="gray95", size = 0.5) +
